...
class CityscapesDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        self.cityscapes_test = Cityscapes(root=self.env["cityscapes_root"], split="test", target_type="semantic")
        self.cityscapes_train = Cityscapes(root=self.env["cityscapes_root"], split="train", target_type="semantic")
