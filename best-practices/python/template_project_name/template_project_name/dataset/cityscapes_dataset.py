...
class Cityscapes(torch.utils.data.Dataset):
    def __init__(self, root, split, target_type):
        ...
        self.dataset_default = TVCityscapes(
            root=root, split=split, target_type=target_type
        )
        
        self.resize_image = torchvision.transforms.Resize(size=(480,640), interpolation=InterpolationMode.BILINEAR)
        self.resize_label = torchvision.transforms.Resize(size=(480,640), interpolation=InterpolationMode.NEAREST)
